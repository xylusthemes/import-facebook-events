<div class="ife-wizard-wrap" >
    ...
    <div class="ife-wizard-starter-video" >
        <a id="ife-watch-video-btn" href="javascript:void(0)" class="ife-wizard-button-style">
            ...
            <p><?php esc_attr_e( 'Getting Started Video', 'import-facebook-events' ); ?></p>
        </a>
    </div>

    <div class="ife-wizard-open-popup-box" >
        <button class="ife-wizard-open-popup add-event ife-wizard-button-style" onclick="window.open('<?php echo esc_url( 'https://developers.facebook.com/apps' ); ?>', '_blank', 'noopener,noreferrer');">
            ...
            <span><?php esc_attr_e( 'Create Facebook App', 'import-facebook-events' ); ?></span>
        </button>
        <button class="ife-wizard-open-popup ife-settings ife-wizard-button-style" id="ife_wizard_setting_button" onclick="window.location.href='<?php echo esc_url( admin_url( 'admin.php?page=facebook_import&tab=settings' ) ); ?>';" >
            ...
            <span><?php esc_attr_e( 'Settings', 'import-facebook-events' ); ?></span>
        </button>
        <div style="clear:both" ></div>
    </div>

    <div class="ife-wizard-back-box" >
        <button class="ife-wizard-back-button">
            ...
            <span onclick="window.location.href='<?php echo esc_url( admin_url( 'admin.php?page=facebook_import&tab=dashboard' ) ); ?>';" ><?php esc_attr_e( 'Back to WordPress Dashboard', 'import-facebook-events' ); ?></span>
        </button>
    </div>
    <a href="admin.php?page=facebook_import&tab=dashboard" title="close" class="ife-wizard-close-button">
...
<div id="ife-wizard-video-popup" class="ife-popup-overlay">
    <div class="ife-popup-content">
        <span id="ife-wizard-close-popup" class="ife-close-btn">&times;</span>
        <iframe id="ife-wizard-video-frame" width="1350" height="700" src="" frameborder="0" allow="autoplay; encrypted-media" allowfullscreen></iframe>
    </div>
</div>