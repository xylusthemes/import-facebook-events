				...
				<table class="form-table">
					<tbody>
						<tr>
							...
							<td>
								<select name="ical_import_by" id="ical_import_by">
									...
									<option value="ical_url" 
									<?php
									if ( ife_is_pro() ) {
										echo 'selected="selected"'; }
									?>
									 ><?php esc_attr_e( 'iCal URL', 'import-facebook-events' ); ?></option>
								</select>
								<span class="ife_small">
									<?php esc_attr_e( 'Select Event source.', 'import-facebook-events' ); ?>
								</span>
							</td>
						</tr>
						...
						<tr class="ical_url_wrapper">
							...
							<td>
								<input class="ife_text ical_url" name="ical_url" type="text" 
								<?php
								if ( ! ife_is_pro() ) {
								...
								/>
								<span class="ife_small">
									<?php esc_attr_e( 'Enter iCal URL ( Eg. https://www.facebook.com/events/ical/upcoming/?uid=XXXXXXXXXXXXXX&key=XXXXXXXXXXXXXX )', 'import-facebook-events' ); ?>
								</span>
