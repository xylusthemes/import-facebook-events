			...
			<div class="iee-support-features">
				<div class="iee-support-features-card">
					<div class="iee-support-features-img">
						<img class="iee-support-features-icon" src="<?php echo IEE_PLUGIN_URL.'assets/images/document.svg'; ?>" alt="<?php esc_attr_e( 'Looking for Something?', 'import-facebook-events' ); ?>">
					</div>
					<div class="iee-support-features-text">
						<h3 class="iee-support-features-title"><?php esc_attr_e( 'Looking for Something?', 'import-facebook-events' ); ?></h3>
						<p><?php esc_attr_e( 'We have documentation of how to import facebook events.', 'import-facebook-events' ); ?></p>
						<a target="_blank" class="button button-primary" href="https://docs.xylusthemes.com/docs/import-facebook-events/"><?php esc_attr_e( 'Plugin Documentation', 'import-facebook-events' ); ?></a>
					</div>
				</div>
				<div class="iee-support-features-card">
					<div class="iee-support-features-img">
						<img class="iee-support-features-icon" src="<?php echo IEE_PLUGIN_URL.'assets/images/call-center.svg'; ?>" alt="<?php esc_attr_e( 'Need Any Assistance?', 'import-facebook-events' ); ?>">
					</div>
					<div class="iee-support-features-text">
						<h3 class="iee-support-features-title"><?php esc_attr_e( 'Need Any Assistance?', 'import-facebook-events' ); ?></h3>
				...
				<div class="iee-support-features-card">
					<div class="iee-support-features-img">
						<img class="iee-support-features-icon"  src="<?php echo IEE_PLUGIN_URL.'assets/images/bug.svg'; ?>" alt="<?php esc_attr_e( 'Found Any Bugs?', 'import-facebook-events' ); ?>" />
					</div>
					<div class="iee-support-features-text">
						<h3 class="iee-support-features-title"><?php esc_attr_e( 'Found Any Bugs?', 'import-facebook-events' ); ?></h3>
				...
				<div class="iee-support-features-card">
					<div class="iee-support-features-img">
						<img class="iee-support-features-icon" src="<?php echo IEE_PLUGIN_URL.'assets/images/tools.svg'; ?>" alt="<?php esc_attr_e( 'Require Customization?', 'import-facebook-events' ); ?>" />
					</div>
					<div class="iee-support-features-text">
						<h3 class="iee-support-features-title"><?php esc_attr_e( 'Require Customization?', 'import-facebook-events' ); ?></h3>
				...
				<div class="iee-support-features-card">
					<div class="iee-support-features-img">
						<img class="iee-support-features-icon" src="<?php echo IEE_PLUGIN_URL.'assets/images/like.svg'; ?>" alt="<?php esc_attr_e( 'Like The Plugin?', 'import-facebook-events' ); ?>" />
					</div>
					<div class="iee-support-features-text">
						<h3 class="iee-support-features-title"><?php esc_attr_e( 'Like The Plugin?', 'import-facebook-events' ); ?></h3>
