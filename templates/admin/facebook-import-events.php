			...
			<form method="post" id="ife_facebook_form">
				<table class="form-table">
					<tbody>
						...
						<tr>
							<th scope="row">
								<?php esc_html_e( 'Author', 'import-facebook-events' ); ?> :
							</th>
							<td>
								<?php
								wp_dropdown_users(
								...
								?>
								<span class="ife_small">
									<?php esc_html_e( 'Select event author for imported events. Default event author is current loggedin user.', 'import-facebook-events' ); ?>
								</span>
							</td>
						</tr>
					</tbody>
